CREATE TABLE `account` (
	...
	`scope` text,
	`password` text,
	`created_at` integer DEFAULT '"2025-09-13T22:16:21.038Z"' NOT NULL,
...
CREATE TABLE `session` (
	...
	`token` text NOT NULL,
	`created_at` integer DEFAULT '"2025-09-13T22:16:21.037Z"' NOT NULL,
	`updated_at` integer NOT NULL,
	`ip_address` text,
	`user_agent` text,
	`user_id` text NOT NULL,
...
CREATE TABLE `user` (
	...
	`image` text,
	`created_at` integer DEFAULT '"2025-09-13T22:16:21.037Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-09-13T22:16:21.037Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `verification` (
	...
	`expires_at` integer NOT NULL,
	`created_at` integer DEFAULT '"2025-09-13T22:16:21.038Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-09-13T22:16:21.038Z"' NOT NULL
);
--> statement-breakpoint
CREATE TABLE `character` (
	...
	`image_crop` text,
	`notes` text,
	`created_at` integer DEFAULT '"2025-09-13T22:16:21.045Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-09-13T22:16:21.045Z"' NOT NULL,
